import { getPddEnvPresence, PddApiError, queryMemberAuthority } from './_lib/pdd.js';
...
export default async function handler(req, res) {
  ...
  if (req.method !== 'POST') {
    ...
    res.status(405).json({ ok: false, error: 'method-not-allowed', message: 'Use POST /api/pdd-authority-query.' });
    return;
  }
